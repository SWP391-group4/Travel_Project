...
<html>
    ...
    <body>
        ...
        <div class="hero-wrap js-fullheight" style="background-image: url('images/restaurant_background(2).jpg');">
    ...
    <section class="ftco-section">
        <div class="container">
            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="container" >
                        <h3 style="float: left; font-weight: bold">Flight destination</h3>
                        <a style="float: right" href="RestaurantList">View all</a>
                    </div>
                        ...
                        <div class="col-sm col-md-6 col-lg-4 ftco-animate">
                            <div class="destination">
                                ...
                                <div class="text p-3">
                                    <div class="d-flex">
                                        <div class="one">
                                            <h3><a href="#">${c.restaurantName}</a></h3>
                                            <p class="rate">
                                                <i class="icon-star"></i>
                                                <i class="icon-star"></i>
                                                <i class="icon-star"></i>
    ...
    <div style="background-color: #dbe3ab;">
        <div class="container-fluid hero-wrap js-fullheight">
            <div class="container ">
                <div class="row justify-content-center mb-5 pb-3">
                    <div class="col-md-7 heading-section text-center ftco-animate">
